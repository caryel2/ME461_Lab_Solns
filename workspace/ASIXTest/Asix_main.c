...
void setDACB(float dacouta1) {
    int16_t DACOutInt = 0;
    DACOutInt = (4096.0/3.0)*dacouta1;  // perform scaling of 0 – almost 3V to 0 - 4095
    if (DACOutInt >  4095) DACOutInt =  4095;
    if (DACOutInt < 0) DACOutInt = 0;
...
//    GPIO_SetupPinOptions(5, GPIO_INPUT, GPIO_PULLUP);
    ...
    init_serialSCID(&SerialD,1250000);
//    init_serialSCID(&SerialD,115200);


    GPIO_SetupPinMux(4, GPIO_MUX_CPU1, 1); //GPIO PinName, CPU, Mux Index
    GPIO_SetupPinMux(5, GPIO_MUX_CPU1, 1); //GPIO PinName, CPU, Mux Index
    ...
    EPwm3Regs.TBPRD = 2500;  // Set Period to 1ms sample.  Input clock is 50MHz.
...
//  EALLOW;
    ...
    sendarray[1] = 'a';
    sendarray[2] = 'n';
    serial_sendSCID(&SerialD, sendarray, 3);
    sendarray[0] = 'T';
    sendarray[1] = 'r';
    sendarray[2] = 'y';
    sendarray[3] = '2';
    serial_sendSCID(&SerialD, sendarray, 4);
...
__interrupt void ADCD_isr(void)
{
    adc1 = AdcdResultRegs.ADCRESULT0;
    adc2 = AdcdResultRegs.ADCRESULT1;
    eqep1 = EQep1Regs.QPOSCNT;
    eqep2 = EQep2Regs.QPOSCNT;

    sendarray[0] = (char)((adc1>>8)&0xFF);
    sendarray[1] = (char)((adc1)&0xFF);
    sendarray[2] = (char)((adc2>>8)&0xFF);
    sendarray[3] = (char)((adc2)&0xFF);
    sendarray[4] = (char)((eqep1>>24)&0xFF);
    sendarray[5] = (char)((eqep1>>16)&0xFF);
    sendarray[6] = (char)((eqep1>>8)&0xFF);
    sendarray[7] = (char)((eqep1)&0xFF);
    sendarray[8] = (char)((eqep2>>24)&0xFF);
    sendarray[9] = (char)((eqep2>>16)&0xFF);
    sendarray[10] = (char)((eqep2>8)&0xFF);
    sendarray[11] = (char)((eqep2)&0xFF);

    GpioDataRegs.GPACLEAR.bit.GPIO0 = 1;

    serial_sendSCID(&SerialD, sendarray, 12);
    SerialD_state = 0;
